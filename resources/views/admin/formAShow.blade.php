          ...
          <div class="shadow-sm p-3 mb-5 bg-white rounded">
            ...
            <table class="table">
              <tbody>
                ...
                <tr>
                  <th>Designation</th>
                  <td>{{$formAdetails->designation}}</td>
                </tr>
                <tr>
                  <th>Department</th>
                  <td>{{$formAdetails->department}}</td>
                </tr>
                <tr>
                  <th>Faculty</th>
                  <td>{{$formAdetails->faculty}}</td>
                </tr>
                <tr>
                  <th>Tel</th>
                  <td>{{$formAdetails->tel}}</td>
                </tr>
                <tr>
                  <th>Email</th>
            ...
            <div class="modal-footer">
              ...
              <th>
                <tr>
                      <th>
                    @if(Auth::user()->id=='1')
              <a href="/markAsapprovedformA/{{$formAdetails->id}}" class="btn btn-primary">Click to VC Approved</a>
          <td>
          @if($formAdetails->isapprovedvc)
            ...
            @if(Auth::user()->id=='2')
            <a href="/markAsapprovedformA/{{$formAdetails->id}}" class="btn btn-primary"> click to Dean Approved</a>
            <td>
          @if($formAdetails->isapprovedean)
              ...
              @endif
              @if(Auth::user()->id=='3')
              <a href="/markAsapprovedformA/{{$formAdetails->id}}" class="btn btn-primary">Click to Grant Approved</a>
              <td>
          @if($formAdetails->isapprovedgrant)
            ...
            @if(Auth::user()->id=='4')
            <a href="/markAsapprovedformA/{{$formAdetails->id}}" class="btn btn-primary"> Click to Head of the department Approved</a>
            <td>
          @if($formAdetails->isapprovedhead)
