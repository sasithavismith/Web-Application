               ...
               <div class="container" style="background-color: #520103;">
                  <div class="navbar-wrapper">
                     ...
                     <a class="navbar-brand" href="#pablo">
                        <img src="../assets/img/logo.png" class="img-logo" style="height: 69px;padding: 5px 10px;margin: 2px 20px 0 0;float: left;vertical-align: middle;">
                        <h4 class="logo-text" style="padding: 5px 10px;margin: 7px 0;font-size: 13px;color: #fff;">Sabaragamuwa University of Sri Lanka</h4>
                        <h4 class="logo-text-4" style="padding-left: 100px;font-size: 12px;color: #fff;margin: 0;">Belihuloya Sri Lanka</h4>
                     </a>
                  </div>
